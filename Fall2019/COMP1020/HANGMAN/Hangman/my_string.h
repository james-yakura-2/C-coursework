...
//-create the MY_STRING

//Precondition: None
//Postcondition: Allocate space for a string object that represents the empty string. The string will have capacity 7 and size 0 by default. A copy of the address fo the opaque object will be returned on success and NULL on failure.
...
//   with the same value as the given c-string.  The capacity of the string//   object will be set to be one greater than is required to hold the string.
//   As an example, the string "the" would set capacity at 4 instead of 3. A//   copy of the address of the opaque object will be returned on success and
//   NULL on failure.
...
//-destroy the MY_STRING

//Precondition: phMy_string holds the address fo a valid handle to a MY_STRING object.
//Postcondition: the menory used for the MY_STRING object has been reclaimed by the system and the handle referred to by the pointer phMy_string has been set to NULL.
